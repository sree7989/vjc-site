      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12" data-aos="fade-up">
          ...
          <div className="lg:w-2/3 w-full space-y-6 text-black">
            {[ 
              "Personalized University & Course Counselling: Get tailored advice on top GERMANY universities and programs that match your profile and career goals.",
              "Complete Application & Visa Guidance: End-to-end support, from preparing your application to securing your GERMANY student visa.",
              "Experienced Counsellors: Friendly, qualified experts with up-to-date knowledge of GERMANY immigration and education policies.",
              "Proven Success: Over 1,200 successful student admissions to leading GERMANY institutions.",
        ...
        >
          ...
          <div className="absolute inset-0 bg-[url('/germany-student-visa-process.jpg')] bg-cover bg-center">
