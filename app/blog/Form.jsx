...
const Form = () => {
  ...
  <input
    ...
    className="w-full px-8 py-2 focus:outline-none bg-white text-black font-bold border-b-2 border-gray-500 focus:border-gray-500 transition"
    required
    value={name}
  ...
  />
        ...
        <div>
          ...
          <input
            ...
            placeholder="Your Email"
             className="w-full px-8 py-2 focus:outline-none bg-white text-black font-bold border-b-2 border-gray-500 focus:border-gray-600 transition"
            required
            value={email}
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-white to-gray-800 text-black py-2 rounded-lg font-semibold hover:bg-saffron transition-all duration-200 shadow-lg"
          disabled={loading}
        >
