...
const courses = [
  ...
  { name: "DUOLINGO", path: "/duolingo", bg: "/Start-an-Overseas-Education-Consultancy-vjc.jpg" },
];
  ...
  return (
    <div className="w-full min-h-screen text-gray-900 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        ...
        <h2 className="text-1xl font-bold -mt-8 text-black">Take the First Step Towards Language Mastery Today!</h2>
