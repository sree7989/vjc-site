...
const backgroundImages = [
  { src: '/singapore-study-visa-process-vjc.jpg', alt: 'Singapore University Campus' },
  { src: '/singapore.jpg', alt: 'Happy Indian Students in singapore' },
  { src: '/singapore-student-visa-process.jpg', alt: 'Singapore Education System' },
];
      ...
      <div className="relative z-20 w-full max-w-[1440px] md:ml-4 flex flex-col lg:flex-row items-center justify-center gap-10">
        ...
        <div className="flex flex-col items-center lg:items-start w-full lg:w-1/2 space-y-4">
          ...
          <Image
            ...
            priority
          />
          <h1 className="text-white text-3xl sm:text-[2.5rem] lg:text-[3rem] lg:ml-12 font-bold leading-tight text-center lg:text-left uppercase">
            <span style={{ fontFamily: 'Times New Roman, Times, serif' }}>
              Study in{' '}
              <span className="bg-gradient-to-r from-white via-red-500 to-red-500 bg-clip-text text-transparent font-extrabold">
                Singapore
              </span>{' '}
              with <span className="text-saffron md:ml-54">VJC OVERSEAS</span>
            </span>
          </h1>
          <p className="text-white text-sm sm:text-base text-center lg:ml-8 lg:text-left max-w-xl">
            Begin your academic journey in one of the world’s most prestigious and opportunity-rich countries.
            With expert guidance from <span className="font-semibold text-saffron">VJC Overseas</span>, you're one step closer to studying in the Singapore.
          </p>
