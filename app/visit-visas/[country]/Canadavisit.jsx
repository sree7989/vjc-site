// pages/canada-visit-visa.tsx
import Image from 'next/image';
export default function CanadaVisitVisa() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 font-[Times_New_Roman]">
      <h1 className="text-xl sm:text-2xl md:text-2xl font-bold mb-8 text-center">
        Canada Visit Visa from India – Apply with <span className="text-orange-500">VJC Overseas</span>
      </h1>
      ...
      <ul className="list-disc list-inside">
        ...
        <li>Stay Duration: Up to 6 months per visit</li>
        <li>Processing Time: Approximately 15–45 days</li>
        <li>Biometrics Required: Yes</li>
      </ul>
      ...
      <div className="border border-gray-300 p-4 rounded bg-gray-50 mt-4">
        ...
        <ul className="list-disc list-inside mt-2">
          ...
          <li>Food & Dining: ₹25,000 – ₹40,000</li>
          <li>Transport (Public/Local Travel): ₹5,000 – ₹15,000</li>
      ...
      <ul className="list-disc list-inside">
        ...
        <li>Letter of invitation (if visiting family or friends)</li>
      ...
      <ul className="list-disc list-inside">
        ...
        <li>Document verification and application filing</li>
        <li>Biometric appointment scheduling</li>
        <li>Regular updates & follow-ups with IRCC</li>
      ...
      <ul className="list-disc list-inside">
        ...
        <li>CN Tower, Toronto – Iconic skyline view</li>
        <li>Old Quebec City – European charm in North America</li>
