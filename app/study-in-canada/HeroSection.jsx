...
const backgroundImages = [
  { src: '/canada.webp', alt: 'canada University Campus' },
  { src: '/the-university-of-toronto-university-canada.jpg', alt: 'Happy Indian Students in Canada' },
  { src: '/canada-student-full-visa-process.avif', alt: 'German Education System' },
];
        ...
        <div className="flex flex-col items-center lg:items-start w-full lg:w-1/2 space-y-4">
          ...
          <h1 className="text-white text-3xl sm:text-[2.5rem] lg:text-[3rem] lg:ml-16 font-bold leading-tight text-center lg:text-left uppercase">
            <span style={{ fontFamily: 'Times New Roman, Times, serif' }}>
              Study in{' '}
              <span className="bg-gradient-to-r from-red-600 via-white to-red-600 bg-clip-text text-transparent font-extrabold">
                CANADA
              </span>{' '}
          ...
          <p className="text-white text-sm sm:text-base text-center lg:ml-4 lg:text-left max-w-xl">
            ...
            With expert guidance from <span className="font-semibold text-saffron">VJC Overseas</span>, you're one step closer to studying in the Canada.
          </p>
