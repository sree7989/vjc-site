...
const AnimatedHeader = () => {
  ...
  const germanyWord = "CANADA"; // The word to animate
    ...
    <h2 className="text-2xl font-bold text-center uppercase text-gray-800 mt-0 lg:mt-1 relative">
      ...
      <span className="inline-block">
        {germanyWord.split("").map((letter, index) => (
          ...
          >
            <span className="inline-block bg-gradient-to-r from-red-500 via-black  to-red-500 bg-clip-text text-transparent">
              {letter}
            </span>
          </motion.span>
        ))}
