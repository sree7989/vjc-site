  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 -mt-8 font-[Times_New_Roman]">
      <h1 className="flex justify-center text-lg sm:text-xl md:text-xl font-bold mb-6 text-center">
        Thailand Tourist Visa Process with Affordable Tour Packages – Experience Thailand with <span className="text-orange-500">&nbsp;VJC Overseas</span>
      </h1>
      ...
      <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
        ...
        <div className="md:w-1/2 w-full rounded-lg overflow-hidden">
          <Image
            src="/thailand-best-places.jpg"
            alt="Thailand Tour by VJC Overseas"
            width={600}
            height={350}
      ...
      <h2 className="text-xl font-bold mb-3 text-[#0D5BA8]">What is a Thailand Tourist Visa?</h2>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        ...
        <li>Proof of financial means (bank statements or salary slips)</li>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        <li>Free consultation to assess eligibility and select the right visa type</li>
        <li>Step-by-step guidance on document preparation</li>
        <li>Accurate filling and timely submission of your visa application</li>
        <li>Appointment scheduling and tracking of visa status</li>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        ...
        <li>Comfortable hotel stays in popular destinations like Bangkok, Phuket, Pattaya, and Chiang Mai</li>
        <li>Guided tours of temples, markets, islands, and cultural sites</li>
        <li>Exciting activities such as island hopping, elephant sanctuaries, and street food tours</li>
        <li>Detailed itineraries designed for your preferences and budget</li>
