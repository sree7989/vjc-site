    ...
    <div className="max-w-6xl mx-auto px-4 py-8 -mt-8 font-[Times_New_Roman]">
      ...
      <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
        ...
        <div className="md:w-1/2 w-full rounded-lg overflow-hidden">
          <Image
            src="/el-nido-island-hopping-tour-a-everything.jpg"
            alt="Philippines Tour by VJC Overseas"
            width={600}
            height={350}
      ...
      <h2 className="text-xl font-bold mb-3 text-[#0D5BA8]">What is a Philippines Tourist Visa?</h2>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        ...
        <li>Proof of accommodation bookings in the Philippines</li>
        <li>Bank statements or financial documents showing sufficient funds</li>
        <li>Travel itinerary detailing your planned activities</li>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        <li>Free consultation to evaluate your travel plans and visa eligibility</li>
        <li>Detailed guidance on document preparation and verification</li>
        <li>Accurate filling and submission of your visa application</li>
        <li>Assistance with scheduling visa appointment and biometric submission if required</li>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        ...
        <li>Comfortable hotel accommodations ranging from budget to premium options</li>
        <li>Guided tours to popular destinations like Manila, Cebu, Palawan, Boracay, and Bohol</li>
        <li>Island hopping, snorkeling, diving, and other water activities</li>
        <li>Cultural tours, local market visits, and nature explorations</li>
        <li>Customized day-wise itineraries for a seamless travel experience</li>
        <li>Visa assistance and travel insurance included</li>
      </ul>
      <p className="mb-5 text-base text-justify leading-snug">
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        ...
        <li>Customized travel and visa solutions for all budgets</li>
        <li>Dedicated and responsive customer support throughout your journey</li>
      </ul>
...
export default PhilippinesTour;
