  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 -mt-8 font-[Times_New_Roman]">
      <h1 className="flex justify-center text-lg sm:text-xl md:text-xl font-bold mb-6 text-center">
        Andaman Tourist Visa Process with Affordable Tour Packages – Explore Andaman with <span className="text-orange-500">&nbsp;VJC Overseas</span>
      </h1>
      ...
      <div className="flex flex-col md:flex-row items-start gap-6 mb-2">
        ...
        <div className="md:w-1/2 w-full rounded-lg overflow-hidden">
          <Image
            src="/Andaman-blog.jpg"
            alt="Andaman Tour by VJC Overseas"
            width={600}
            height={350}
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        <li>Valid government-issued photo ID (passport, Aadhaar card, voter ID)</li>
        <li>Passport-sized photographs</li>
        <li>Completed application form for the Restricted Area Permit</li>
        <li>Travel itinerary and confirmed accommodation details</li>
        <li>Proof of return or onward travel tickets</li>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        <li>Consultation to verify eligibility and clarify documentation requirements</li>
        <li>Complete assistance with form filling and document preparation</li>
        <li>Fast-track permit application submission</li>
        <li>Regular updates and status tracking of your permit application</li>
        <li>Help with travel insurance and forex exchange for your trip</li>
      </ul>
      <p className="mb-5 text-base text-justify leading-snug">
        We ensure your permit application is flawless and approved on time, so you can focus on planning your holiday.
      </p>
      ...
      <ul className="list-disc list-inside mb-5 text-base text-justify space-y-1.5">
        ...
        <li>Comfortable accommodations ranging from budget hotels to resorts</li>
        <li>Guided tours to iconic spots like Radhanagar Beach, Cellular Jail, Ross Island, and Havelock Island</li>
        <li>Water sports activities including snorkeling, scuba diving, and sea walking</li>
        <li>Island hopping excursions and nature treks</li>
        <li>Detailed day-wise itinerary for hassle-free sightseeing</li>
        <li>Permit and travel insurance handling included</li>
      </ul>
      <p className="mb-5 text-base text-justify leading-snug">
