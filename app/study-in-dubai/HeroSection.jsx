...
>
  ...
  >
    <Image
      src="dubai.svg" // Replace with your image path
      alt="Background"
      fill
  ...
  Study in{' '}
  <span className="bg-gradient-to-r from-red-500 via-green-500 to-white bg-clip-text text-transparent font-extrabold">
    DUBAI
  </span>{' '}
