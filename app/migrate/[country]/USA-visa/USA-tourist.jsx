    ...
    <div className="m-2 p-2" style={{
      ...
      <div style={{ marginBottom: '5%' }}>
        <h3 className="text-3xl mt-4 font-semibold text-black text-center">
          USA Visit Visa  - VJC Overseas<span style={{ color: 'rgb(220, 4, 4)' }}>VJC Overseas</span>
        </h3>
      </div>
      ...
      Are you planning to visit the United States for tourism, business meetings, or to attend a family event? The USA Visit Visa, also known as the B-1/B-2 visa, allows individuals to travel to the United States for temporary stays. At VJC Overseas, we provide expert guidance and support throughout your visa application process, ensuring a smooth and efficient experience.Are you planning to visit the United States for tourism, business meetings, or to attend a family event? The USA Visit Visa, also known as the B-1/B-2 visa, allows individuals to travel to the United States for temporary stays. At VJC Overseas, we provide expert guidance and support throughout your visa application process, ensuring a smooth and efficient experience.
      </p>
      ...
      <div className="flex mb-6 flex-col lg:flex-row items-start h-auto lg:space-x-6 space-y-4 lg:space-y-0">
        ...
        <div>
          <h4 className="mb-6 m-2 font-bold text-lg text-black">Types of USA Visit Visas:</h4>
          <ul className='ml-8 mb-6 list-disc'>
        <li><b>B-1 Visa:  </b>For individuals visiting the USA for business purposes, such as meetings, conferences, or negotiations.</li>
        <li><b>B-2 Visa:  </b>For tourists traveling to the USA for leisure, vacations, visiting family or friends, or seeking medical treatment.</li>
        <li><b>E-1/B-2 Visa: </b>A combination of both B-1 and B-2 visas, typically issued for people with mixed intentions (business and leisure).</li>
      ...
      <h4 className="mb-6 m-2 font-bold text-lg text-black">Eligibility Criteria:</h4>
      <p className='mb-6 m-2'>To qualify for a USA Visit Visa, applicants must:</p>
      <ul className='ml-8 mb-6 list-decimal'>
        <li><b>Demonstrate the purpose of the visit: </b>You must provide evidence of your travel intentions, such as an invitation letter from a relative, business partner, or event organizer in the USA.</li>
        <li><b>Prove strong ties to your home country:  </b>This includes family, a job, financial obligations, or property, which assures the authorities that you intend to return to your country after the visit.</li>
        <li><b>Financial Stability: </b>You must prove that you have enough funds to support yourself during your stay in the USA, without relying on public assistance..</li>
        <li><b>Good Moral Character: </b>You should not have a criminal history or immigration violations.</li>
      </ul>

      <h4 className="mb-6 m-2 font-bold text-lg text-black">Documents Checklist for USA Visit Visa:</h4>
      <p className='mb-6 m-2'>To ensure your application is complete, you must submit the following documents along with your visa application:</p>
      <h4 className='text-sky-800 m-2 mb-6 italic'>Mandatory Documents:</h4>
      <ul className='ml-8 mb-6 list-decimal'>
        <li><b>Valid Passport: </b>Must be valid for at least 6 months beyond your intended stay in the USA.</li>
        <li><b>DS-160 Form:  </b>The visa application form, filled out completely and accurately.</li>
        <li><b>Visa Appointment Confirmation: </b>Proof of scheduling your visa interview at the US Embassy or Consulate.</li>
        <li><b>Photographs:  </b>Recent passport-sized color photographs that meet US visa photo requirements.</li>
        <li><b>Visa Interview Confirmation:</b> A copy of the confirmation page from your interview scheduling.</li>
        <li><b>Purpose of Visit Documentation:</b>
        <ul className='' style={{listStyleType:"circle"}}>
          <li>Invitation letter (for family or business visits)</li>
          <li>Conference invitation or event registration (for business or tourism purposes)</li>
          <li>Hotel reservations or travel itinerary (for tourism)</li>
        </ul>
        </li>
        <li><b>Proof of Financial Support:</b> Bank statements for the last 3-6 months, pay slips, tax returns, or sponsorship letter if someone else is sponsoring your trip.</li>
        <li><b>Travel History:</b> If applicable, provide details of previous visits to other countries, especially if you have traveled to the USA or Schengen areas before.</li>
      </ul>

      <h4 className='text-sky-800 m-2 mb-6 italic'>Additional Documents(if applicable):</h4>
      <ul className='list-decimal m-2 mb-6' style={{listStyleType:"circle"}}>
          <li><b>Employment or Business Documents:</b> Employment letter, business registration documents, or other proof of employment/business ties to demonstrate strong ties to your home country.</li>
          <li><b>Marriage Certificate or Birth Certificate:</b> If visiting family members, provide relevant certificates to establish relationship ties.</li>
          <li><b>Medical Records:</b> If seeking medical treatment, a letter from the US-based medical institution detailing the treatment plan.</li>
        </ul>

        <h4 className="mb-6 m-2 font-bold text-lg text-black">Visa Processing Time:</h4>
      <p className='mb-6 m-2'>The processing time for a USA Visit Visa varies depending on the country, season, and individual circumstances. On average, the visa processing time is between <b>5 to 10 business days</b> after the interview. However, it is recommended to apply well in advance, typically <b>3-6 months</b> before your intended travel date, as additional processing time may be required in some cases.</p>

<h4 className="mb-6 m-2 font-bold text-black">Important Points to Note:</h4>
<ul className='list-decimal m-2 mb-6' style={{listStyleType:"circle"}}>
          <li>Interview Wait Time: Depending on the US Embassy or Consulate, the wait time for an interview appointment can vary, so it's crucial to schedule your appointment as early as possible.</li>
          <li>Additional Processing: In some cases, administrative processing may delay the issuance of your visa. This can take anywhere from a few days to several weeks, depending on the circumstances.</li>
        </ul>
        <h4 className="mb-6 m-2 font-bold text-lg text-black">Why Choose VJC Overseas for Your USA Visit Visa?</h4>
        <p className='mb-6 m-2'>At VJC Overseas, we understand that the visa application process can be overwhelming. Our expert team provides personalized consultation, ensures that all your documents are in order, and prepares you for the visa interview. We are committed to helping you obtain your USA Visit Visa with confidence and ease.</p>
        ...
        <p className='mb-6 m-2'>Let VJC Overseas be your trusted partner in securing your USA Visit Visa. Get in touch with us today to start your visa application journey!</p>
        <p className='mb-6 m-2 font-bold'>Contact Us Today to Book Your Consultation!</p>
