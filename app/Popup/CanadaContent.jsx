  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-3 mt-0 md:-mt-4">
        <h2 className="text-xl sm:text-3xl font-bold bg-gradient-to-r from-red-400 via-white to-red-400 bg-clip-text text-transparent drop-shadow-lg">
          Study in CANADA 2025
        </h2>
        <p className="text-sm sm:text-base font-medium leading-relaxed text-white">
          Unlock prestigious <span className="text-yellow-400 font-semibold">canada universities</span> with no tuition fees, strong job opportunities, and global recognition. Get support with{" "}
          ...
          <span className="text-yellow-400 font-semibold">study programs</span> that ensure your academic success and cultural experience in Canada.
        </p>
      </div>
    </div>
  );
