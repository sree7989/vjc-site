    ...
    >
      ...
      <div className="relative z-10 space-y-3 mt-0 md:-mt-4">
        ...
        <p className="text-sm sm:text-base font-medium leading-relaxed text-white">
          Apply for your <span className="text-orange-400 font-semibold">Schengen visa</span> effortlessly with <span className="text-orange-400">VJC Overseas</span>. Get <span className="text-orange-400">expert guidance</span>, smooth documentation, and timely approvals for <span className="text-orange-400">travel across Europe</span>. Enjoy stress-free travel planning with our trusted support.
        </p>
      </div>
    </div>
  );
...
export default SchengenVisaContent;
