      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12" data-aos="fade-up">
          ...
          <div className="lg:w-2/3 w-full space-y-6 text-black">
            {[ 
              "Personalized University & Course Counselling: Get tailored advice on top USA universities and programs that match your profile and career goals.",
              "Complete Application & Visa Guidance: End-to-end support, from preparing your application to securing your USA student visa.",
              "Experienced Counsellors: Friendly, qualified experts with up-to-date knowledge of USA immigration and education policies.",
              "Proven Success: Over 1,000 successful student admissions to leading USA institutions.",
        ...
        >
          ...
          >
            ...
            <p className="text-white text-1sm max-w-3xl mx-auto mb-6">
              Your dream to study in the USA is one step away! Connect with VJC Overseas, the trusted name in international education consultancy. Book a free consultation and start your academic journey toward a bright future.
            </p>
