    ...
    <div className="px-6 sm:px-12 lg:px-16 py-10 bg-white">
      <div className="text-center mb-6 max-w-4xl mx-auto">
        ...
        <p className="mt-4 text-gray-700 text-sm sm:text-base leading-relaxed">
          Navigating the U.S. visa process can be overwhelming without expert guidance.
          <span className="text-orange-500 font-medium"> VJC Overseas</span> has years of experience in guiding students through every stage of their application. From university shortlisting and documentation to mock interviews and visa file preparation, we ensure your profile meets all U.S. visa requirements.
        </p>
        <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
          <span className="font-medium text-orange-500">Affordable, Transparent, and Result-Driven:</span> We believe in offering transparent services with high success rates. Our tailored support helps students secure admission to top U.S. universities while maximizing their visa approval chances.
        </p>
      </div>
