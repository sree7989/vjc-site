    ...
    <div className="max-w-6xl mx-auto px-4 py-10 -mt-10" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
        ...
        <div className="md:w-1/2 text-justify">
          <p className="mb-4">
            Canada is a top destination for international students, offering a high standard of education, a welcoming multicultural environment, and numerous opportunities for career growth. If you’re planning to study in Canada, obtaining a <a href="https://www.vjcoverseas.com/study-abroad/canada" className="text-orange-600">Canada Student Visa Consultants</a> (Study Permit) is an essential step. <strong className="text-black">VJC Overseas</strong> guides you through the process, ensuring a smooth and successful application journey.
          </p>
        </div>
      </div>
      ...
      <p className="mb-4">
        At <strong className="text-black">VJC Overseas</strong>, we understand that the process of applying for a Canadian student visa can be overwhelming. Our experts offer step-by-step guidance, personalized counselling, and help you choose the right course and institution in Canada. We are recognized as one of the <a href="https://www.vjcoverseas.com/" className="text-orange-600">Best Visa Immigration Consultants</a> with years of proven experience. We also assist with <a href="https://www.vjcoverseas.com/work-abroad/canada-work-permit" className="text-orange-600">Canada Work permit visa</a> guidance for students planning to work after graduation.
      </p>
      ...
      {/* New Final Paragraph */}
      <p className="mt-6">
        <strong className="text-black">Start Your Journey Today</strong> – Your Canadian dream is just a step away. Partner with <a href="https://www.vjcoverseas.com/" className="text-orange-600">VJC Overseas</a> – the experts who turn aspirations into reality. Contact us today for a consultation and take the first confident step toward your international education.
      </p>
    </div>
  );
};
